...
Revision ID: 40d91ef5021e
Revises: 
Create Date: 2023-08-28 17:35:19.430923
...
def upgrade() -> None:
    ...
    sa.Column('initial_anomaly_detection_baseline', sa.BLOB(), nullable=False),
