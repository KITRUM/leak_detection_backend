...
Revision ID: b37ebb8e2e41
Revises: 
Create Date: 2023-07-29 11:06:18.176212
...
def upgrade() -> None:
    ...
    op.create_table(
        "estimations_summaries",
        sa.Column("result", sa.String(), nullable=False),
        sa.Column("confidence", sa.Float(), nullable=False),
        sa.Column(
            "simulation_detection_rate_ids", sa.String(), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["sensor_id"],
            ["sensors.id"],
            name=op.f("fk_estimations_summaries_sensor_id_sensors"),
            ondelete="RESTRICT",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f(
                "fk_simulation_detection_rates_anomaly_detection_id_anomaly_detections"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "id", name=op.f("pk_simulation_detection_rates")
        ),
    )
